...
upscale_tiled_detail = 'Upscale (Tiled SDXL Detail 2x)'
upscale_fast = 'Upscale (Fast 2x)'

uov_list = [disabled, subtle_variation, strong_variation, upscale_15, upscale_2, upscale_tiled_detail, upscale_fast]
